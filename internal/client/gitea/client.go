...
func Run(ctx context.Context, args []string, stdout, stderr io.Writer) int {
	...
	if err != nil {
		writeDiagnostic(stderr, usage)
		return 2
	}
	config, err := clientconfig.LoadEnv()
	if err != nil {
		writeDiagnostic(stderr, "tea: client configuration failed\n")
		return 1
	}
	...
	if err != nil {
		...
		writeDiagnostic(stderr, "tea: connection failed\n")
		return 1
	}
...
func interrupted(ctx context.Context, stderr io.Writer) int {
	writeDiagnostic(stderr, "tea: interrupted\n")
